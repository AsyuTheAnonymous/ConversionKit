...
document.getElementById('plainTextInput').addEventListener('input', function(e) {
  // No specific button to enable/disable here, as actions are direct
});
...
async function convertTextToUppercase() {
  ...
  if (!text) {
    textOutput.value = 'Please enter text to convert.';
    return;
  }
